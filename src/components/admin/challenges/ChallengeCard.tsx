    ...
    <Card className="hover:shadow-lg transition-shadow">
      <CardHeader>
        <div className="flex justify-between items-start">
          <div className="space-y-2">
            <CardTitle className="text-xl text-amber-900 dark:text-gray-100">{challenge.title}</CardTitle>
            <CardDescription className="text-amber-700 dark:text-gray-400">{challenge.description}</CardDescription>
          </div>
      ...
      <CardContent>
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex items-center gap-1 text-sm text-amber-700 dark:text-gray-400">
