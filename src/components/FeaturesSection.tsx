    ...
    <section id="features" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Why Choose Gabalang?</h2>
          <p className="text-xl text-amber-700 dark:text-gray-400 max-w-3xl mx-auto">Experience the most comprehensive and engaging way to learn African languages with cutting-edge technology and cultural authenticity.</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <p className="text-amber-700 dark:text-gray-400 text-sm leading-relaxed">{feature.description}</p>
            </div>
          ))}
        </div>
              ...
              <div className="bg-card/20 backdrop-blur-sm rounded-xl p-8 border border-border">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <div className="text-amber-700">African Languages</div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-6 text-sm">
                  <div className="text-center">
                    <div className="text-2xl font-bold">50K+</div>
                    <div className="text-amber-700">Active Learners</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold">95%</div>
                    <div className="text-amber-700">Success Rate</div>
                  </div>
                </div>
              </div>
            </div>
